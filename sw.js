...
self.addEventListener('fetch', event => {
  ...
  event.respondWith(fetch(req, { cache: 'no-store' }).catch(() => new Response('', { status: 503, statusText: 'Offline: network required for Stage 6F recovery build' })));
});
