...
Package version: `prototype-101r59-stage8a-r49s-predeploy-check`

Evidence stage: `Stage 8A/R49S — evidence/packaging fix: manifest.json resynced (stale since R49K), predeploy_check.py added; no runtime change`
