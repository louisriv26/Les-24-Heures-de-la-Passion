...
Package version: `prototype-101r59-stage8a-r49z-speech-defer-resolutions`

Evidence stage: `Stage 8A/R49Z — Category C: resolved held speech-attribution items — tagged BENEFITS.P187 JESUS (continuity) and removed MARY tag from H24.DESOL.P033 (nested flèches quote), per user rulings`
