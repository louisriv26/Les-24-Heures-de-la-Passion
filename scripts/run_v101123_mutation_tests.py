...
OUT.write_text(json.dumps({'schema':'L24H_V101123_MUTATION_TEST_MATRIX_V1','baseline_validator_errors':base,'summary':summary,'mutations':mutations},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
