...
async def main():
 ...
 obj={'schema':'L24H_V101121_INDEPENDENT_PRESENTATION_MATRIX_V1','version':VERSION,'implementation':'independent grouped-target text-node range mapper using real renderParaText DOM/computed styles','summary':summary,'results':results}
