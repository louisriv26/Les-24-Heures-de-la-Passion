...
async def main():
 ...
 OUT.write_text(json.dumps({'schema':'L24H_V101124_INDEPENDENT_HOUR24_PROBE_V1','version':VER,'implementation':'separate browser probe; does not call primary Hour-24 matrix','summary':summary,'rows':rows},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
