...
async def main():
 ...
 OUT.write_text(json.dumps({'schema':'L24H_V101123_FIVE_PROFILE_UX_MATRIX_V1','version':VERSION,'browser':'system Chromium via Playwright content injection','physical_device_limitation':'NOT physical-device evidence','summary':summary,'results':results},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
