...
# 20 syntax matrix
r20=[]
add(r20,'identity_v101129',"const APP_VERSION = 'v101.129';" in H and "const APP_EVIDENCE_STAGE = 'INTRA_RECORD_QUOTE_HOST_SENTENCE_CONTINUITY_R1';" in H)
...
dump('20_INTRA_RECORD_QUOTE_HOST_SYNTAX_MATRIX.json',{'schema':'L24H_V101129_QUOTE_HOST_SYNTAX_MATRIX_V1','version':'v101.129','summary':sm(r20),'rows':r20})
# 22 valid controls
r22=[]
...
dump('22_VALID_BREAK_CONTROL_MATRIX.json',{'schema':'L24H_V101129_VALID_BREAK_CONTROL_MATRIX_V1','version':'v101.129','summary':sm(r22),'rows':r22})
# 23 parity
r23=[]
...
dump('23_PROJECTION_TOPOLOGY_PARITY_MATRIX.json',{'schema':'L24H_V101129_PROJECTION_TOPOLOGY_PARITY_V1','version':'v101.129','summary':sm(r23),'rows':r23})
...
dump('24_SPEAKER_CONSERVATION_MATRIX.json',{'schema':'L24H_V101129_SPEAKER_CONSERVATION_V1','version':'v101.129','summary':sm(r24),'rows':r24})
...
async def browser_matrices():
 ...
 async with async_playwright() as pw:
  ...
  await b.close()
 dump('21_INTRA_RECORD_QUOTE_HOST_CONTINUITY_GEOMETRY_MATRIX.json',{'schema':'L24H_V101129_QUOTE_HOST_GEOMETRY_V1','version':'v101.129','browser':'Chromium wide synthetic geometry; physical devices remain external','summary':sm(r21),'rows':r21})
 dump('25_RENDERED_TEXT_CONSERVATION_MATRIX.json',{'schema':'L24H_V101129_RENDERED_TEXT_CONSERVATION_V1','version':'v101.129','summary':sm(r25),'rows':r25})
 dump('26_USER_STATE_TOPOLOGY_MATRIX.json',{'schema':'L24H_V101129_USER_STATE_TOPOLOGY_V1','version':'v101.129','note':'Character offsets are unchanged; this matrix verifies corrected Samsung/visual-paragraph range topology. Physical Samsung remains external.','summary':sm(r26),'rows':r26})
 dump('27_REPERES_PRESENTATION_MATRIX.json',{'schema':'L24H_V101129_SPEAKER_RETURN_PRESENTATION_V1','version':'v101.129','summary':sm(r27),'rows':r27})
...
dump('28_MUTATION_DETECTION_MATRIX.json',{'schema':'L24H_V101129_MUTATION_DETECTION_V1','version':'v101.129','summary':sm(r28),'rows':r28})
