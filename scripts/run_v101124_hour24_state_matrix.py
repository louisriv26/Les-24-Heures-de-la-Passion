...
async def main():
 ...
 OUT.write_text(json.dumps({'schema':'L24H_V101124_HOUR24_STATE_TRANSITION_MATRIX_V1','version':VERSION,'browser':'system Chromium via Playwright content injection','real_device_limitation':'browser emulation only; physical-device gates not claimed','summary':summary,'rows':rows},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
