...
async def main():
 ...
 OUT.write_text(json.dumps({'schema':'L24H_V101130_USER_STATE_ANCHOR_APPLE_SELECTION_V1','version':'v101.130','scope':'Chromium semantic simulation of persisted anchors and WebKit-style exact selection offsets; physical Apple/Samsung remain external','summary':summary,'rows':rows},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
