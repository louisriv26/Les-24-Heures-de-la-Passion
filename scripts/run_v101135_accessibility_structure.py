...
async def main():
    ...
    obj={'schema':'L24H_V101135_ACCESSIBILITY_STRUCTURE_RECONCILIATION_V1','provenance':'Direct browser structure check on the preserved v101.133 renderer logic; does not claim physical VoiceOver/TalkBack evidence.','summary':sm,'rows':out,'physical_screen_reader_gate':'OPEN'}
