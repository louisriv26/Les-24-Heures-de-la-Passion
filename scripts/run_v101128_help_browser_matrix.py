...
async def main():
 ...
 OUT.write_text(json.dumps({'schema':'L24H_V101128_HELP_BROWSER_MATRIX_V1','version':VERSION,'browser':'system Chromium via Playwright content injection','real_device_limitation':'Not physical Safari/Samsung/TalkBack/VoiceOver evidence','summary':summary,'results':rows},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
