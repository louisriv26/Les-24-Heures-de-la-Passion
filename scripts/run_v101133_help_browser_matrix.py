...
async def main():
 ...
 OUT.write_text(json.dumps({'schema':'L24H_V101133_HELP_BROWSER_MATRIX_OPTIMIZED_V1','version':VERSION,'browser':'system Chromium via Playwright single content injection; five viewport/user-agent passes','equivalence_note':'Same 14 assertions per profile as inherited v101.128 help matrix; optimization removes repeated full-HTML parsing only.','real_device_limitation':'Not physical Safari/Samsung/TalkBack/VoiceOver evidence','summary':summary,'results':rows},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
